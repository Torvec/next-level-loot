      ...
      <section className="container mx-auto max-w-5xl space-y-6 border-y-2 border-y-muted px-4 py-16 text-muted-foreground xl:px-0">
        <div>
          ...
          <div className="space-y-6">
            <p>
              Next Level Loot is primarily a portfolio piece to showcase my
              skills as a web developer, and as a way for me to learn how to
              build a site using{" "}
              <ExtLink href="https://nextjs.org/">Next.js</ExtLink> and{" "}
              <ExtLink href="https://shadcn.dev/">shadcn/ui</ExtLink>{" "}
              components. It is also a continuation of a previous project,
              called{" "}
              ...
              in 2023. Like Loot Vault, Next Level Loot is a site that
              aggregates game data from multiple APIs and allows gamers to find
              deals, giveaways, and information about games.
            </p>
            <p>
        ...
        <div>
          ...
          <p>
            Hello, my name is Edward Vonschondorf, and I am a freelance full
            stack developer located in the San Francisco Bay Area. I enjoy
            making full stack apps as well as games. Check out{" "}
        ...
        <div>
          ...
          <p>
            Updates/Improvments and bug fixes will continue on a regular basis
            for the foreseeable future as it has been a great experience for me
            to have a fully-featured site, excluding database usage, for me to
        ...
        <div>
          ...
          <p className="text-sm">
            ...
            data provided. Additionally, I do not own any trademarks or
            copyrights for the games or other content displayed on this site.
